...
public class TestWithMockInjected {
    ...
    public interface TestComponent extends DataComponent {
        void inject(TestWithMockInjected myTest);
    }
    ...
    public void setUp() {
        ...
        TestComponent component = DaggerTestWithMockInjected_TestComponent.builder()
//                .debugDataModule(new DebugDataModule(mockState))
                .build();
        app.setDataComponent(component);   // set the component in DemoApplication
